...
export default async function TestBridgesPage() {
  ...
  const topToday = await getTopContentToday('bridge')
  const topWeek = await getTopContentThisWeek('bridge')
      ...
      <div className="max-w-2xl mx-auto text-center py-20">
        <div className="crm-card space-y-6">
          ...
          <p className="text-lg text-[#a0a0a0]">
            There are no bridges in the system yet. Please ask an admin to add some bridges.
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Main Content */}
      <div className="max-w-4xl mx-auto">
        <HookCard initialHook={initialHook} contentType="bridge" />
      </div>
          ...
          <ul className="space-y-4 text-[#a0a0a0]">
            <li className="flex items-start gap-4 p-4 rounded-lg bg-[#2a2a2a] border border-[#353535]">
              ...
              <span className="flex-1">
                Click <strong className="text-white">"This Hook Works"</strong> if the bridge caught your attention and would make you engage
              </span>
            </li>
            <li className="flex items-start gap-4 p-4 rounded-lg bg-[#2a2a2a] border border-[#353535]">
              <span className="text-white">✗</span>
              <span className="flex-1">
                Click <strong className="text-white">"Needs Improvement"</strong> if the bridge feels weak or uninteresting
              </span>
            </li>
            <li className="flex items-start gap-4 p-4 rounded-lg bg-[#2a2a2a] border border-[#353535]">
              <span className="text-white">★</span>
              <span className="flex-1">
                Click <strong className="text-white">"Save Hook"</strong> to bookmark bridges you like. Access them anytime from the Saved page!
              </span>
            </li>
            <li className="flex items-start gap-4 p-4 rounded-lg bg-[#2a2a2a] border border-[#353535]">
              <span className="text-white">→</span>
              <span className="flex-1">
                Click <strong className="text-white">"Skip this hook"</strong> to see a different bridge without voting
              </span>
            </li>
          </ul>
        </div>
