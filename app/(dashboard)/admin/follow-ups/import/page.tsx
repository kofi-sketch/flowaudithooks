...
export default function ImportFollowUpsPage() {
  ...
  const handleImport = async () => {
    ...
    const result = await bulkCreateHooks(validHooks, 'followup')
    setResults(result)
    setImporting(false)
      ...
      <div>
        <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
          <div className="animate-[slide-up_0.4s_ease-out]">
            <h1 className="text-[32px] font-semibold text-white mb-2">Bulk Import Follow-ups</h1>
            <p className="text-base text-[#a0a0a0]">
              Upload a CSV file to import multiple follow-ups at once
            </p>
          </div>
          <Link href="/admin">
        ...
        <div className="crm-card bg-[#2a2a2a] mb-6 animate-[slide-up_0.5s_ease-out_0.1s] opacity-0" style={{ animation: 'slide-up 0.5s ease-out 0.1s forwards' }}>
          ...
          <p className="text-sm text-[#a0a0a0] mb-4">
            Your CSV file should have one follow-up per row. You can use either format:
          </p>
...
Another follow-up here
            ...
            <div>
              ...
              <pre className="text-xs bg-[#2d2d2d] border border-[#353535] p-3 rounded-lg overflow-x-auto text-[#a0a0a0]">
text,notes
Follow-up text here,Optional note
Another follow-up here,Another note
              </pre>
            </div>
          </div>
        </div>
        ...
        <div className="crm-card">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button
              ...
              size="md"
            >
              {importing ? 'Importing...' : `Import ${validCount} Follow-ups`}
            </Button>
          </div>
        ...
        <div className="crm-card">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-[#2a2a2a] border border-[#353535] rounded-lg p-4">
              ...
              <div className="text-sm text-[#a0a0a0]">Follow-ups Created</div>
            </div>
